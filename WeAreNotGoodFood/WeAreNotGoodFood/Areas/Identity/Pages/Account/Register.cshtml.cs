...
namespace WeAreNotGoodFood.Areas.Identity.Pages.Account
{
    ...
    {
        public RegisterModel(SignInManager<IdentityUser> signInManager, UserManager<IdentityUser> userManager, ILogger<RegisterModel> logger, IEmailSender emailSender, FileUploadService fileUploadService, IHostingEnvironment environment)
        {
