...
namespace WeAreNotGoodFood.Controllers
{
    public class RestaurantsController : Controller
    {
        ...
        public RestaurantsController(ApplicationDbContext context, IHostingEnvironment environment,
            FileUploadServiceWe fileUploadService, UserManager<IdentityUser> userManager)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("Name,ImagesRestaurant,Description,Id")]
            Restaurant restaurant, RestaurantVM model)
        {
            if (ModelState.IsValid)
            {
                ...
                restaurantUpload.UserId = user.Id;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Name,ImagesRestaurant,Description,Id")]
